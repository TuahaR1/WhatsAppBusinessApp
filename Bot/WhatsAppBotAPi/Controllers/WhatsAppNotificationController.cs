...
namespace WhatsAppBotAPi.Services.Controllers
{
    ...
    public class WhatsAppNotificationController : ControllerBase
    {
        ...
        public WhatsAppNotificationController(ILogger<WhatsAppNotificationController> logger, IWhatsAppBusinessClient whatsAppBusinessClient,
            IOptions<WhatsAppConfig> whatsAppConfig, IWebHostEnvironment webHostEnvironment)
        {
            _logger = logger;
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (messageType.Equals("text"))
                    {
                        ...
                        textMessageReplyRequest.Context = new WhatsAppBotAPi.Services.Messages.ReplyRequests.TextMessageContext();
                    ...
                    if (messageType.Equals("location"))
                    {
                        ...
                        locationMessageReplyRequest.Context = new WhatsAppBotAPi.Services.Messages.ReplyRequests.LocationMessageContext();
                        ...
                        locationMessageReplyRequest.Location = new WhatsAppBotAPi.Services.Messages.Requests.Location();
